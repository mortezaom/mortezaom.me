<template>
  <section class="section work" id="work">
    ...
    <button>More Projects on the way</button>
  </section>
</template>
...
const works = ref([
  ...
  },
  {
    ...
    link: "https://codecanyon.net/item/paper-flutter-news-app-with-firebase-backend/28068212",
    technologies: [
      "Dart",
      "Flutter",
      "Firebase",
  ...
  },
  {
    ...
    link: "https://github.com/mortezaom/MDToast",
